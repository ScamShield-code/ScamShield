      ...
      {activeTab === 'privacy' && (
        <>
          ...
          {[
            ...
            { icon: 'fa-user-secret',   color: '#10b981', glow: 'rgba(16,185,129,0.3)', title: 'No Personal Identification',   body: 'ScamShield does not collect names, device IDs, or any personally identifiable information. Reports are anonymous.' },
